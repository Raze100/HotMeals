...
import NavbarCSS from '../components/NavbarCSS.css'
...
export default function Navbar() {
  ...
  <nav className="navbar navbar-expand-lg navbar-dark bg-danger">
    <div className="container-fluid">
      <img className='mb-4' src={logo} width={64} height={64} />
      <Link className="navbar-brand fs-1 fst-italic" to="/">HotMeals</Link>
